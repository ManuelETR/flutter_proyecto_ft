...
import 'package:flutter_proyecto_ft/data/models/addres_model.dart'; // Importa AddressModel
...
class _ClientFormState extends ConsumerState<ClientForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.existingClient == null ? 'Agregar Cliente' : 'Editar Cliente'),
      ),
      body: Padding(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      final newClient = ClientModel(
                        ...
                        address: address, name: null, // Pasar AddressModel
                      );
